...
Shader "DEC/Surface/Surface Gradient Height"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord2_g39586 = i.uv_texcoord * appendResult150_g38531 + appendResult151_g38531;
			...
			float3 temp_output_1478_59_g38531 = UnpackScaleNormal( temp_output_1_0_g39549, temp_output_8_0_g39549 );
			float3 temp_output_38_0_g39592 = temp_output_1478_59_g38531;
			...
			float3 break277_g39556 = ( temp_output_275_0_g39556 - temp_cast_4 );
			...
			float4 temp_output_39_0_g39592 = ( temp_output_7_0_g38531 + float4(0,0,0,0) );
			...
			o.Metallic = ( _MetallicStrength * _MASK_B1440_g38531 ).r;
			...
			float4 temp_cast_23 = (i.vertexColor.a).xxxx;
			...
			o.Smoothness = ( temp_output_1267_33_g38531 * lerpResult14_g38531 ).x;
			o.Occlusion = saturate( lerpResult14_g38531 ).r;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18913
486;116;1467;857;-457.6082;1159.358;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;290;1377.96,-881.2607;Inherit;False;343.5028;190.4201;DEBUG SETTINGS ;3;293;353;291;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;295;1379.783,-1014.665;Inherit;False;167;123;GLOBAL SETTINGS ;1;294;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;464;1380.689,-260.329;Inherit;False;336.0021;120.4324;DESF Common ASE Compile Shaders;1;465;;0,0.2605708,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;467;696.2634,-683.0129;Inherit;False;DESF Core Surface;3;;38531;c3df20d62907cd04086a1eacc41e29d1;19,1352,0,183,0,1382,1,1432,1,1433,1,1434,1,1491,0,1284,2,1446,0,307,0,312,0,1318,0,249,0,1319,0,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
