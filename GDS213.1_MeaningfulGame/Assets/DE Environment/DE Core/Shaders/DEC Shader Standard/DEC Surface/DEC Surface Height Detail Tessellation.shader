...
Shader "DEC/Surface/Surface Height Detail Tessellation"
{
	...
	SubShader
	{
		...
		float4 float4switch20_g39599( int m_switch, float4 m_Off, float4 m_Active )
		{
			if(m_switch ==0)
				return m_Off;
			else if(m_switch ==1)
		...
		{
			int m_switch20_g39599 = _TessellationMode;
			float4 temp_cast_1 = (1.0).xxxx;
			float4 m_Off20_g39599 = temp_cast_1;
			float4 m_Active20_g39599 = UnityDistanceBasedTess( v0.vertex, v1.vertex, v2.vertex, _TessellationDistanceMin,_TessellationDistanceMax,_TessellationStrength);
			float4 localfloat4switch20_g39599 = float4switch20_g39599( m_switch20_g39599 , m_Off20_g39599 , m_Active20_g39599 );
			return localfloat4switch20_g39599;
		}
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 uv_TexCoord2_g39586 = v.texcoord.xy * appendResult150_g38532 + appendResult151_g38532;
			...
			v.vertex.xyz += ( temp_output_309_0_g38532 + localfloat3switch74_g39558 );
			v.vertex.w = 1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_38_0_g39592 = localfloat3switch1310_g38532;
			...
			float3 temp_output_1478_66_g38532 = (WorldNormalVector( i , UnpackScaleNormal( temp_output_1_0_g39549, temp_output_8_0_g39549 ) ));
...
/*ASEBEGIN
Version=18913
486;116;1467;857;-539.926;1047.223;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;295;1379.783,-1011.665;Inherit;False;172;118;GLOBAL SETTINGS ;1;294;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;290;1376.96,-882.2607;Inherit;False;362.5028;192.4201;DEBUG SETTINGS ;3;293;291;353;;0,0,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;467;706.8609,-683.8604;Inherit;False;DESF Core Surface;3;;38532;c3df20d62907cd04086a1eacc41e29d1;19,1352,0,183,0,1382,1,1432,1,1433,1,1434,1,1491,0,1284,0,1446,0,307,0,312,0,1318,1,249,1,1319,1,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
...
Node;AmplifyShaderEditor.FunctionNode;466;1398.965,-222.693;Inherit;False;DESF Common ASE Compile Shaders;-1;;39591;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=AEF9AE79B2BD1DA05F8B1E2537432AC8555305C9